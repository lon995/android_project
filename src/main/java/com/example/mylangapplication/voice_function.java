...
import static com.iflytek.cloud.SpeechRecognizer.createRecognizer;

public class voice_function extends AppCompatActivity implements View.OnClickListener{
    private static final String TAG = "voice_function";

    private com.iflytek.cloud.SpeechRecognizer mIat;// 语音听写对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIat = createRecognizer(voice_function.this, mInitListener);
        // 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
        mIatDialog = new RecognizerDialog(voice_function.this, mInitListener);
    ...
    private void showMsg(String msg) {
        Toast.makeText(voice_function.this, msg, Toast.LENGTH_SHORT).show();
    }
